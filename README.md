...
## 📈 Proven Impact (Quick Highlights)
* **Modernization:** Migrated an untested legacy monolith into a Modular Monolith at TREZ Inc, scaling backend test coverage to 80%.
* **Cost Reduction:** Slashed monthly AWS infrastructure overhead by 53% ($1,700 to $800/mo) through architecture and instance optimization.
* **Automation:** Automated a critical SaaS financial billing process, shrinking manual operations from 2 weeks down to under 2 hours.
